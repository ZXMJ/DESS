...
def index_data(df_docs,source,index_name,index_name_knn,index_name_else):
    i=0
...
df_docs = pd.read_csv('/mnt/workspace/rag/RAG/date/NQ_context_file.csv')
source ="nq"
