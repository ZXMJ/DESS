...
index_name_knn = "research_index_knn_nq"
index_name = "research_index_bm25_nq"
index_name_elser = "research_index_elser_nq"

validation_dataset = pd.read_csv("/mnt/workspace/rag/RAG/date/NQ.csv")
